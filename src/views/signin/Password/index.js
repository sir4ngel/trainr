            ...
            <View style={styles.dataContainer}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20 }}>
                    <TouchableOpacity style={{ backgroundColor: colors.input, justifyContent: 'center', alignItems: 'center', borderRadius: 5 }} onPress={isAccepted ? () => setIsAccepted(false) : () => setIsAccepted(true)} disabled={isDisabled}>
                        {
                            isAccepted ?
                                <View style={{ height: 15, width: 15, borderRadius: 7.5, backgroundColor: colors.primaryTitle, margin: 5 }} /> :
                                <View style={{ height: 15, width: 15, borderRadius: 7.5, backgroundColor: colors.input, margin: 5 }} />
                        }
                    </TouchableOpacity>
