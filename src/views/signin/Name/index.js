    ...
    return (
        <View style={styles.container}>
            <View style={styles.dataContainer}>
                ...
                <TextInput selectionColor={colors.primaryTitle} style={styles.input} onChangeText={(value) => onHandleInputText(1, value)} ></TextInput>
                <Text style={[styles.title, { marginTop: 25 }]}>Escribe tus apellidos</Text>
                <TextInput selectionColor={colors.primaryTitle} style={styles.input} onChangeText={(value) => onHandleInputText(2, value)} ></TextInput>
